...
/**
 * Representa��o de um grupo de estudos.
...
public class Grupo {
	...
	/**
	 * Constr�i um grupo a partir de um nome.
	 * Um grupo come�a sem nenhum aluno.
	 ...
	 * e False caso algum erro ocorra e o aluno n�o for adicionado.
	...
	/**
	 * Retorna uma representa��o em String de um grupo.
